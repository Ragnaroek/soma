...
fn test_ld() -> Result<(), ExecErr> {
    let cases: [(&str, IO, Register, &[u8], u16, Register, &[(u16, u8)]); 28] = [
        ...
        (
            ...
            IO::init(),
            Register::zero(),
            &[psy::arch::sm83::INSTR_LD_TO_H_FROM_IMMEDIATE.op_code, 0x66],
            2,
            RegBuilder::new().h(0x66).reg(),
            &[],
        ),
        (
            "(ld ('label) %a)",
        ...
        (
            "(ld %d %a)",
            IO::init(),
            RegBuilder::new().d(0x01).a(0x66).reg(),
            &[psy::arch::sm83::INSTR_LD_TO_D_FROM_A.op_code],
            1,
            RegBuilder::new().d(0x66).a(0x66).reg(),
            &[],
        ),
        (
            "(ld %e %a)",
...
fn test_dec() -> Result<(), ExecErr> {
    let cases: [(&str, IO, Register, &[u8], Register, &[(u16, u8)]); 22] = [
        // (dec %a)
        (
            "(dec %a) with 1 %a",
            IO::init(),
            RegBuilder::new().a(0x01).f_z(0).f_n(0).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_A.op_code],
            RegBuilder::new().a(0x00).f_z(1).f_n(1).f_h(0).reg(),
            &[],
        ),
        (
            "(dec %a) with 0 %a",
            IO::init(),
            RegBuilder::new().a(0x0).f_z(1).f_n(0).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_A.op_code],
            RegBuilder::new().a(0xFF).f_z(0).f_n(1).f_h(1).reg(),
            &[],
        ),
        (
            "(dec %a) no half carry",
            IO::init(),
            RegBuilder::new().a(0x15).f_z(1).f_h(1).reg(),
            &[psy::arch::sm83::INSTR_DEC_A.op_code],
            RegBuilder::new().a(0x14).f_z(0).f_n(1).f_h(0).reg(),
            &[],
        ),
        (
            "(dec %a) half carry",
            IO::init(),
            RegBuilder::new().a(0x10).f_z(1).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_A.op_code],
            RegBuilder::new().a(0x0F).f_z(0).f_n(1).f_h(1).reg(),
            &[],
        ),
        // (dec %b)
        (
        ...
        (
            "(dec %h) with 1 %h",
            IO::init(),
            RegBuilder::new().h(0x01).f_z(0).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_H.op_code],
            RegBuilder::new().h(0x00).f_z(1).f_n(1).f_h(0).reg(),
            &[],
        ),
        (
            "(dec %h) with 0 %h",
            IO::init(),
            RegBuilder::new().h(0x0).f_z(1).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_H.op_code],
            RegBuilder::new().h(0xFF).f_z(0).f_n(1).f_h(1).reg(),
            &[],
        ),
        (
            "(dec %h) no half carry",
            IO::init(),
            RegBuilder::new().h(0x15).f_z(1).f_h(1).reg(),
            &[psy::arch::sm83::INSTR_DEC_H.op_code],
            RegBuilder::new().h(0x14).f_z(0).f_n(1).f_h(0).reg(),
            &[],
        ),
        (
            "(dec %h) half carry",
            IO::init(),
            RegBuilder::new().h(0x10).f_z(1).f_h(0).reg(),
            &[psy::arch::sm83::INSTR_DEC_H.op_code],
            RegBuilder::new().h(0x0F).f_z(0).f_n(1).f_h(1).reg(),
            &[],
        ),
        (
            "(dec %bc) with 1 %bc",
